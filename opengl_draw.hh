...
extern float get_string_width(flFont *, float, flMonoOption, char *);
extern void draw_string(float, float, float, float, float, float, float, flFont *, flMonoOption, char *);
