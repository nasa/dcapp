...
extern void setup_panel(float, float, int, int, float, float, float);
extern float get_string_width(void *, float, flMonoOption, char *);
extern void draw_string(float, float, float, float, float, float, void *, flMonoOption, char *);
...
extern void line_start(float, float, float, float);
extern void line_end(void);
extern void polygon_outline_start(float, float, float, float);
extern void polygon_outline_end(void);
extern void polygon_fill_start(float, float, float);
extern void polygon_fill_end(void);
extern void gfx_vertex(float, float);
extern void rectangle_outline(float, float, float, float, float, float, float, float, float, float, float, float);
extern void rectangle_fill(float, float, float, float, float, float, float, float, float, float, float);
extern void circle_outline(float, float, float, int, float, float, float, float);
extern void circle_fill(float, float, float, int, float, float, float);
