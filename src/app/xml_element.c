...
DcAppXmlElementType dc_app_xml_element_type_from_string(const char *name) {
    if (strcmp(name, "Arc") == 0)
        return DC_APP_XML_ELEMENT_TYPE_ARC;
    if (strcmp(name, "Arg") == 0)
        return DC_APP_XML_ELEMENT_TYPE_ARG;
    if (strcmp(name, "Blink") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BLINK;
    if (strcmp(name, "Button") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON;
    if (strcmp(name, "ButtonDisabled") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_DISABLED;
    if (strcmp(name, "ButtonEnabled") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_ENABLED;
    if (strcmp(name, "ButtonIndicatorOff") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_INDICATOR_OFF;
    if (strcmp(name, "ButtonIndicatorOn") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_INDICATOR_ON;
    if (strcmp(name, "ButtonPressed") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_PRESSED;
    if (strcmp(name, "ButtonReleased") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_RELEASED;
    if (strcmp(name, "ButtonTransition") == 0)
        return DC_APP_XML_ELEMENT_TYPE_BUTTON_TRANSITION;
    if (strcmp(name, "Constant") == 0)
        return DC_APP_XML_ELEMENT_TYPE_CONSTANT;
    if (strcmp(name, "Container") == 0)
        return DC_APP_XML_ELEMENT_TYPE_CONTAINER;
    if (strcmp(name, "DCAPP") == 0)
        return DC_APP_XML_ELEMENT_TYPE_DCAPP;
    if (strcmp(name, "Default") == 0)
        return DC_APP_XML_ELEMENT_TYPE_DEFAULT;
    if (strcmp(name, "Dummy") == 0)
        return DC_APP_XML_ELEMENT_TYPE_DUMMY;
    if (strcmp(name, "EdgeFrom") == 0)
        return DC_APP_XML_ELEMENT_TYPE_EDGE_FROM;
    if (strcmp(name, "EdgeIO") == 0)
        return DC_APP_XML_ELEMENT_TYPE_EDGE_IO;
    if (strcmp(name, "EdgeTo") == 0)
        return DC_APP_XML_ELEMENT_TYPE_EDGE_TO;
    if (strcmp(name, "EdgeVariable") == 0)
        return DC_APP_XML_ELEMENT_TYPE_EDGE_VARIABLE;
    if (strcmp(name, "Ellipse") == 0)
        return DC_APP_XML_ELEMENT_TYPE_ELLIPSE;
    if (strcmp(name, "False") == 0)
        return DC_APP_XML_ELEMENT_TYPE_FALSE;
    if (strcmp(name, "DrawFunction") == 0)
        return DC_APP_XML_ELEMENT_TYPE_DRAW_FUNCTION;
    if (strcmp(name, "Function") == 0)
        return DC_APP_XML_ELEMENT_TYPE_FUNCTION;
    if (strcmp(name, "If") == 0)
        return DC_APP_XML_ELEMENT_TYPE_IF;
    if (strcmp(name, "Image") == 0)
        return DC_APP_XML_ELEMENT_TYPE_IMAGE;
    if (strcmp(name, "Include") == 0)
        return DC_APP_XML_ELEMENT_TYPE_INCLUDE;
    if (strcmp(name, "Line") == 0)
        return DC_APP_XML_ELEMENT_TYPE_LINE;
    if (strcmp(name, "Logic") == 0)
        return DC_APP_XML_ELEMENT_TYPE_LOGIC;
    if (strcmp(name, "MouseActive") == 0)
        return DC_APP_XML_ELEMENT_TYPE_MOUSE_ACTIVE;
    if (strcmp(name, "MouseHovered") == 0)
        return DC_APP_XML_ELEMENT_TYPE_MOUSE_HOVERED;
    if (strcmp(name, "MouseInactive") == 0)
        return DC_APP_XML_ELEMENT_TYPE_MOUSE_INACTIVE;
    if (strcmp(name, "MouseMotion") == 0)
        return DC_APP_XML_ELEMENT_TYPE_MOUSE_MOTION;
    if (strcmp(name, "MousePressed") == 0)
        return DC_APP_XML_ELEMENT_TYPE_MOUSE_PRESSED;
    if (strcmp(name, "MouseReleased") == 0)
        return DC_APP_XML_ELEMENT_TYPE_MOUSE_RELEASED;
    if (strcmp(name, "Panel") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PANEL;
    if (strcmp(name, "PixelStream") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PIXELSTREAM;
    if (strcmp(name, "Polygon") == 0)
        return DC_APP_XML_ELEMENT_TYPE_POLYGON;
    if (strcmp(name, "Rectangle") == 0)
        return DC_APP_XML_ELEMENT_TYPE_RECTANGLE;
    if (strcmp(name, "Set") == 0)
        return DC_APP_XML_ELEMENT_TYPE_SET;
    if (strcmp(name, "Sphere") == 0)
        return DC_APP_XML_ELEMENT_TYPE_SPHERE;
    if (strcmp(name, "Stencil") == 0)
        return DC_APP_XML_ELEMENT_TYPE_STENCIL;
    if (strcmp(name, "StencilAdd") == 0)
        return DC_APP_XML_ELEMENT_TYPE_STENCIL_ADD;
    if (strcmp(name, "StencilDraw") == 0)
        return DC_APP_XML_ELEMENT_TYPE_STENCIL_DRAW;
    if (strcmp(name, "StencilRemove") == 0)
        return DC_APP_XML_ELEMENT_TYPE_STENCIL_REMOVE;
    if (strcmp(name, "Style") == 0)
        return DC_APP_XML_ELEMENT_TYPE_STYLE;
    if (strcmp(name, "Planet") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET;
    if (strcmp(name, "PlanetBreadcrumbs") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_BREADCRUMBS;
    if (strcmp(name, "PlanetContainer") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_CONTAINER;
    if (strcmp(name, "PlanetData") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_DATA;
    if (strcmp(name, "PlanetEllipse") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_ELLIPSE;
    if (strcmp(name, "PlanetGeoJSON") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_GEO_JSON;
    if (strcmp(name, "PlanetImage") == 0)
    ...
    if (strcmp(name, "PlanetShader") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_SHADER;
    if (strcmp(name, "PlanetSphere") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_SPHERE;
    if (strcmp(name, "PlanetText") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_TEXT;
    if (strcmp(name, "PlanetTexture") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_TEXTURE;
    if (strcmp(name, "PlanetView") == 0)
        return DC_APP_XML_ELEMENT_TYPE_PLANET_VIEW;
    if (strcmp(name, "Text") == 0)
        return DC_APP_XML_ELEMENT_TYPE_TEXT;
    if (strcmp(name, "TrickFrom") == 0)
        return DC_APP_XML_ELEMENT_TYPE_TRICK_FROM;
    if (strcmp(name, "TrickIO") == 0)
        return DC_APP_XML_ELEMENT_TYPE_TRICK_IO;
    if (strcmp(name, "TrickTo") == 0)
        return DC_APP_XML_ELEMENT_TYPE_TRICK_TO;
    if (strcmp(name, "TrickVariable") == 0)
        return DC_APP_XML_ELEMENT_TYPE_TRICK_VARIABLE;
    if (strcmp(name, "True") == 0)
        return DC_APP_XML_ELEMENT_TYPE_TRUE;
    if (strcmp(name, "Variable") == 0)
        return DC_APP_XML_ELEMENT_TYPE_VARIABLE;
    if (strcmp(name, "Vertex") == 0)
        return DC_APP_XML_ELEMENT_TYPE_VERTEX;
    if (strcmp(name, "Window") == 0)
        return DC_APP_XML_ELEMENT_TYPE_WINDOW;
    return DC_APP_XML_ELEMENT_TYPE_UNDEFINED;
}

DcAppXmlElementType dc_app_xml_element_type_from_xml_node(xmlNodePtr node) {
    if (node && node->type == XML_ELEMENT_NODE) {
        const char *name = (const char *)(node->name);
        DcAppXmlElementType type = dc_app_xml_element_type_from_string(name);
        if (type == DC_APP_XML_ELEMENT_TYPE_UNDEFINED) {
            DC_LOG_WARN("Elem", "dc_app_xml_element_type_from_xml_node: Undefined element name: %s", name);
        }
        return type;
    }
    return DC_APP_XML_ELEMENT_TYPE_NONELEM;
}
