...
DcAppValue dc_app_value_create_typed_value_from_string(DcAppValueType type, const char *value_str) {
    ...
    new_value.type = type;
    dc_app_value_set_from_string(&new_value, value_str);
    return new_value;
}

DcAppValue dc_app_value_create_value_string(const char *value) {
    DcAppValue new_value = {0};
    new_value.type = DC_APP_VALUE_TYPE_STRING;
    strncpy(new_value.value_string, value, DC_APP_VALUE_STRING_BUFFER_SIZE - 1);
    new_value.value_string[DC_APP_VALUE_STRING_BUFFER_SIZE - 1] = '\0';
...
DcAppValue dc_app_value_create_value_integer(int value) {
    DcAppValue new_value = {0};
    new_value.type = DC_APP_VALUE_TYPE_INTEGER;
...
DcAppValue dc_app_value_create_value_double(double value) {
    DcAppValue new_value = {0};
    new_value.type = DC_APP_VALUE_TYPE_DOUBLE;
...
DcAppValue dc_app_value_create_value_boolean(bool value) {
    DcAppValue new_value = {0};
    new_value.type = DC_APP_VALUE_TYPE_BOOLEAN;
    ...
    switch (type) {
        case DC_APP_VALUE_TYPE_BOOLEAN:
            ...
            if (value->value_boolean) {
                strncpy(value->value_string, "True", DC_APP_VALUE_STRING_BUFFER_SIZE - 1);
            } else {
                strncpy(value->value_string, "False", DC_APP_VALUE_STRING_BUFFER_SIZE - 1);
            }
            value->value_string[DC_APP_VALUE_STRING_BUFFER_SIZE - 1] = '\0';
            break;
        case DC_APP_VALUE_TYPE_INTEGER:
            value->value_boolean = (bool)value->value_integer;
            value->value_double = (double)value->value_integer;
            snprintf(value->value_string, DC_APP_VALUE_STRING_BUFFER_SIZE, "%d", value->value_integer);
            break;
        case DC_APP_VALUE_TYPE_DOUBLE:
            value->value_boolean = (bool)value->value_double;
            value->value_integer = (int)value->value_double;
            snprintf(value->value_string, DC_APP_VALUE_STRING_BUFFER_SIZE, "%f", value->value_double);
            break;
        case DC_APP_VALUE_TYPE_STRING:
            ...
            break;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_refresh(): invalid value type %d", value->type);
            break;
    }
}

void dc_app_value_set_from_string(DcAppValue *value, const char *value_str) {
    switch (value->type) {
        case DC_APP_VALUE_TYPE_BOOLEAN:
        ...
        case DC_APP_VALUE_TYPE_INTEGER:
            ...
            break;
        case DC_APP_VALUE_TYPE_STRING:
            strncpy(value->value_string, value_str, DC_APP_VALUE_STRING_BUFFER_SIZE - 1);
            value->value_string[DC_APP_VALUE_STRING_BUFFER_SIZE - 1] = '\0';
            break;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_set_from_string(): invalid value type %d", value->type);
            break;
    }
...
void *dc_app_value_get_addr(DcAppValue *value) {
    switch (value->type) {
        ...
        default:
            DC_LOG_ERROR("Value", "dc_app_value_get_addr(): invalid value type %d", value->type);
            break;
    }
    return NULL;
}
...
bool dc_app_value_is_equal(DcAppValue *value1, DcAppValue *value2) {
    switch (value1->type) {
        ...
        default:
            DC_LOG_ERROR("Value", "dc_app_value_is_equal(): invalid value type %d", value1->type);
            break;
    }
    return false;
}
...
bool dc_app_value_is_not_equal(DcAppValue *value1, DcAppValue *value2) {
    switch (value1->type) {
        ...
        case DC_APP_VALUE_TYPE_STRING:
            return strcmp(value1->value_string, value2->value_string) != 0;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_is_not_equal(): invalid value type %d", value1->type);
            break;
    }
    return false;
}
...
bool dc_app_value_is_greater(DcAppValue *value1, DcAppValue *value2) {
    switch (value1->type) {
        ...
        case DC_APP_VALUE_TYPE_DOUBLE:
            return value1->value_double > value2->value_double;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_is_greater(): invalid value type %d", value1->type);
            break;
    }
    return false;
}
...
bool dc_app_value_is_greater_or_equal(DcAppValue *value1, DcAppValue *value2) {
    switch (value1->type) {
        ...
        case DC_APP_VALUE_TYPE_DOUBLE:
            return value1->value_double >= value2->value_double;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_is_greater_or_equal(): invalid value type %d", value1->type);
            break;
    }
    return false;
}
...
bool dc_app_value_is_less(DcAppValue *value1, DcAppValue *value2) {
    switch (value1->type) {
        ...
        case DC_APP_VALUE_TYPE_DOUBLE:
            return value1->value_double < value2->value_double;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_is_less(): invalid value type %d", value1->type);
            break;
    }
    return false;
}
...
bool dc_app_value_is_less_or_equal(DcAppValue *value1, DcAppValue *value2) {
    switch (value1->type) {
        ...
        case DC_APP_VALUE_TYPE_DOUBLE:
            return value1->value_double <= value2->value_double;
        default:
            DC_LOG_ERROR("Value", "dc_app_value_is_less_or_equal(): invalid value type %d", value1->type);
            break;
    }
    return false;
}
