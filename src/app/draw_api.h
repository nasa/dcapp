...
struct DcAppDrawApi {
    ...
    void (*planet_line_local)(DcAppDrawContext *draw_ctx, const DcAppVec2 *points, uint32_t point_count, DcAppStroke stroke);
    void (*planet_polygon_local)(DcAppDrawContext *draw_ctx, const DcAppVec2 *points, uint32_t point_count, DcAppStroke stroke);
    ...
    void (*planet_line_geodetic)(DcAppDrawContext *draw_ctx, DcAppDrawPlanetViewHandle view, const DcAppVec3d *points, uint32_t point_count, DcAppStroke stroke);
    void (*planet_line_cartesian)(DcAppDrawContext *draw_ctx, DcAppDrawPlanetViewHandle view, const DcAppVec3d *points, uint32_t point_count, DcAppStroke stroke);
    void (*planet_polygon_geodetic)(DcAppDrawContext *draw_ctx, DcAppDrawPlanetViewHandle view, const DcAppVec3d *points, uint32_t point_count, DcAppStroke stroke);
    void (*planet_polygon_cartesian)(DcAppDrawContext *draw_ctx, DcAppDrawPlanetViewHandle view, const DcAppVec3d *points, uint32_t point_count, DcAppStroke stroke);
    ...
    void (*planet_image_geodetic)(DcAppDrawContext *draw_ctx, DcAppDrawPlanetViewHandle view, double lat, double lon, double height, DcAppTextureId texture_id, DcAppVec2 size, float rotation_degrees, float yaw_degrees, bool yaw_enabled, DcAppVec4 tint);
    void (*planet_image_cartesian)(DcAppDrawContext *draw_ctx, DcAppDrawPlanetViewHandle view, DcAppVec3d position, DcAppTextureId texture_id, DcAppVec2 size, float rotation_degrees, float yaw_degrees, bool yaw_enabled, DcAppVec4 tint);
