...
1. **`<prefix>.planet.json`** -- A metadata file recording the planet radius, meters per pixel, tile grid dimensions, elevation range, tree depth, and the list of tile files with their latitude/longitude positions.
