...
extern void circle_outline(float, float, float, float, int, float, float, float, float, float, uint16_t, int);
extern void circle_fill(float, float, float, float, int, float, float, float, float);
