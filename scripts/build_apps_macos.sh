...
PL_STATIC_LINK_LIBRARIES=""
PL_DYNAMIC_LINK_LIBRARIES=""
PL_SOURCES="../src/sock.c ../src/value.c ../src/trick.c ../src/edge.c ../src/app/lookup.c ../src/app/elem.c ../src/app/config.c ../src/pixelstream/mjpeg.c ../src/pixelstream/shmem.c ../src/utils/env.c ../src/utils/math.c ../src/utils/time.c ../src/utils/file.c ../src/utils/string.c ../apps/dcapp.c "
PL_LINK_FRAMEWORKS="-framework Metal -framework MetalKit -framework Cocoa -framework IOKit -framework CoreVideo -framework QuartzCore "
