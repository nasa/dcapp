...
@if not exist "../samples/planet_vehicle/logic" @mkdir "../samples/planet_vehicle/logic"
...
@if exist "../samples/planet_vehicle/logic/logic.dll" del "..\samples\planet_vehicle\logic\logic.dll"
@if exist "../samples/planet_vehicle/logic/logic_*.pdb" del "..\samples\planet_vehicle\logic\logic_*.pdb"
...
"../pilotlight/out/dcapp-genheader.exe" ../samples/planet_vehicle/planet_vehicle.xml

@set PL_COMPILER_FLAGS=-Zc:preprocessor -nologo -W4 -WX -wd4201 -wd4100 -wd4996 -wd4505 -wd4189 -wd5105 -wd4115 -O2 -MD 
@set PL_LINKER_FLAGS=-noexp -nologo -noimplib -incremental:no -EXPORT:display_pre_init -EXPORT:display_init -EXPORT:display_draw -EXPORT:display_close 
@set PL_SOURCES="../samples/planet_vehicle/logic/logic.c" 

:: run compiler (and linker)
@echo.
@echo [1m[93mStep: planet_vehicle[0m
@echo [1m[93m~~~~~~~~~~~~~~~~~~~~~~[0m
@echo [1m[36mCompiling and Linking...[0m
cl %PL_COMPILER_FLAGS% %PL_SOURCES% -Fe"../samples/planet_vehicle/logic/logic.dll" -Fo"../samples/planet_vehicle/logic/" -LD -link %PL_LINKER_FLAGS% -PDB:"../samples/planet_vehicle/logic/logic_%random%.pdb"
...
@del "..\samples\planet_vehicle\logic\*.obj"  > nul 2> nul
