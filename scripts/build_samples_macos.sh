...
rm -f ..\samples\test\logic/logic.dylib
rm -f ..\samples\test\logic/logic_*.dylib
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ test | release ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
clang -shared $PL_SOURCES $PL_INCLUDE_DIRECTORIES $PL_DEFINES $PL_COMPILER_FLAGS $PL_INCLUDE_DIRECTORIES $PL_LINK_DIRECTORIES $PL_STATIC_LINK_LIBRARIES $PL_DYNAMIC_LINK_LIBRARIES $PL_LINK_FRAMEWORKS $PL_LINKER_FLAGS -o "./..\samples\test\logic/logic.dylib"
