...
@set PL_SOURCES="../src/sock.c" "../src/trick.c" "../src/value.c" "../src/app/elem.c" "../src/app/lookup.c" "../src/app/config.c" "../src/pixelstream/mjpeg.c" "../src/pixelstream/shmem.c" "../src/utils/env.c" "../src/utils/math.c" "../src/utils/time.c" "../src/utils/file.c" "../src/utils/string.c" "../apps/dcapp.c" 
...
@set PL_SOURCES="../src/app/elem.c" "../src/app/lookup.c" "../src/app/config.c" "../src/utils/env.c" "../src/utils/math.c" "../src/utils/time.c" "../src/utils/file.c" "../src/utils/string.c" "../src/value.c" "../apps/dcapp-genheader.c" 
...
@set PL_LINKER_FLAGS=-incremental:no -nologo -noimplib -noexp 
@set PL_STATIC_LINK_LIBRARIES=libxml2.lib 
@set PL_SOURCES="../src/app/elem.c" "../src/app/lookup.c" "../src/app/config.c" "../src/utils/env.c" "../src/utils/math.c" "../src/utils/time.c" "../src/utils/file.c" "../src/utils/string.c" "../src/value.c" "../apps/dcapp-validate.c" 
