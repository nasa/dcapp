...
typedef struct __NodeContainer {
    _ValIndex2    position;
    _ValIndex2    origin;
    _ValIndex2    dimensions;
    _ValIndex2    virtual_dimensions;
    _ValIndex2    pivot_align;
    _ValIndex2    pivot_point;
    _ValIndex2    alignment;
...
PL_EXPORT void *pl_app_load(plApiRegistryI *api_registry, _PlAppData *pl_app_data) {
    ...
    window_desc.uWidth       = (uint32_t)(dc_app_lookup_get_value(data.lookup, window_node->window.dimensions.x)->value_integer);
    window_desc.uHeight      = (uint32_t)(dc_app_lookup_get_value(data.lookup, window_node->window.dimensions.y)->value_integer);
...
static bool _load_color_from_string(xmlNodePtr xml_node, const char *attr_name, _ValIndex4 *color_out) {
    ...
    if (raw_color) {
        ...
        strncpy(cleaned_color, raw_color, DC_VALUE_STRING_BUFFER_SIZE - 1);
        free(raw_color);
    ...
    switch (elem_type) {
        ...
        case DC_APP_ELEM_TYPE_CONTAINER: {
            ...
            if (raw_x_position) {
                ...
                strncpy(cleaned_x_position, raw_x_position, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_x_position);
            ...
            if (raw_y_position) {
                ...
                strncpy(cleaned_y_position, raw_y_position, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_y_position);
            ...
            if (raw_x_origin) {
                ...
                strncpy(cleaned_x_origin, raw_x_origin, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_x_origin);
                ...
                DcValue value              = dc_value_create_value_double(0.0);
                dc_node.container.origin.x = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_y_origin) {
                ...
                strncpy(cleaned_y_origin, raw_y_origin, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_y_origin);
                ...
                DcValue value              = dc_value_create_value_double(0.0);
                dc_node.container.origin.y = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_x_dimension) {
                ...
                strncpy(cleaned_x_dimension, raw_x_dimension, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                dc_node.container.dimensions.x = parent_dimensions.x;
            }
            ...
            if (raw_y_dimension) {
                ...
                strncpy(cleaned_y_dimension, raw_y_dimension, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                dc_node.container.dimensions.y = parent_dimensions.y;
            }
            ...
            if (raw_x_virtual_dimension) {
                ...
                strncpy(cleaned_x_virtual_dimension, raw_x_virtual_dimension, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                dc_node.container.virtual_dimensions.x = dc_node.container.dimensions.x;
            }
            ...
            if (raw_y_virtual_dimension) {
                ...
                strncpy(cleaned_y_virtual_dimension, raw_y_virtual_dimension, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                dc_node.container.virtual_dimensions.y = dc_node.container.dimensions.y;
            }
            ...
            if (raw_x_align) {
                ...
                strncpy(cleaned_x_align, raw_x_align, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_x_align);
                ...
                dc_node.container.alignment.x = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_y_align) {
                ...
                strncpy(cleaned_y_align, raw_y_align, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_y_align);
                ...
                dc_node.container.alignment.y = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_rotation) {
                ...
                strncpy(cleaned_rotation, raw_rotation, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_rotation);
                ...
                DcValue value              = dc_value_create_value_double(0.0);
                dc_node.container.rotation = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_pivot_point_x && raw_pivot_point_y) {
                ...
                strncpy(cleaned_pivot_point_x, raw_pivot_point_x, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                strncpy(cleaned_pivot_point_y, raw_pivot_point_y, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                dc_node.container.pivot_align.y = dc_app_lookup_register_value(data.lookup, &value);
                ...
                if (raw_pivot_align_x) {
                    ...
                    strncpy(cleaned_pivot_align_x, raw_pivot_align_x, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                if (raw_pivot_align_y) {
                    ...
                    strncpy(cleaned_pivot_align_y, raw_pivot_align_y, DC_VALUE_STRING_BUFFER_SIZE - 1);
                ...
                fprintf(stderr, "DCAPP _process_node(): Container: invalid PivotParameters; must use both PivotPoint params, or none. Using one is not allowed.\n");
            }
        ...
        case DC_APP_ELEM_TYPE_IF: {
            ...
            if (raw_type) {
                ...
                strncpy(cleaned_type, raw_type, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_type);
            ...
            if (raw_value1) {
                ...
                strncpy(cleaned_value1, raw_value1, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_value1);
            ...
            if (raw_value2) {
                ...
                strncpy(cleaned_value2, raw_value2, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_value2);
        ...
        case DC_APP_ELEM_TYPE_LOGIC: {
            ...
            if (raw_filepath) {
                ...
                strncpy(cleaned_filepath, raw_filepath, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_filepath);
        ...
        case DC_APP_ELEM_TYPE_PANEL: {
            ...
            if (raw_x_virtual_dimension) {
                ...
                dc_node.panel.virtual_dimensions.x = parent_dimensions.x;
            }
            ...
            if (raw_y_virtual_dimension) {
                ...
                dc_node.panel.virtual_dimensions.y = parent_dimensions.y;
            }
        ...
        case DC_APP_ELEM_TYPE_POLYGON: {
            ...
            if (raw_line_width) {
                ...
                strncpy(cleaned_line_width, raw_line_width, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_line_width);
            ...
            if (raw_pivot_point_x && raw_pivot_point_y) {
                ...
                DcValue value                 = dc_value_create_value_double(0.0);
                dc_node.polygon.pivot_point.x = dc_app_lookup_register_value(data.lookup, &value);
                dc_node.polygon.pivot_point.y = dc_app_lookup_register_value(data.lookup, &value);

            } else {
                fprintf(stderr, "DCAPP _process_node(): Polygon: invalid PivotParameters; must use both PivotPoint params, or none. Using one is not allowed.\n");
            }
        ...
        case DC_APP_ELEM_TYPE_SET: {
            ...
            if (raw_variable) {
                ...
                strncpy(cleaned_variable, raw_variable, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_variable);
            ...
            if (raw_operand) {
                ...
                strncpy(cleaned_operand, raw_operand, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_operand);
            ...
            if (raw_operator) {
                ...
                strncpy(cleaned_operator, raw_operator, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_operator);
        ...
        case DC_APP_ELEM_TYPE_TERRAIN: {
            ...
            if (raw_x_dimension) {
                ...
                dc_node.terrain.dimensions.x = parent_dimensions.x;
            }
            ...
            if (raw_y_dimension) {
                ...
                dc_node.terrain.dimensions.y = parent_dimensions.y;
            }
            ...
            if (raw_x_align) {
                ...
                DcValue value               = dc_value_create_value_integer(DC_APP_ALIGN_TYPE_LEFT);
                dc_node.terrain.alignment.x = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_y_align) {
                ...
                DcValue value               = dc_value_create_value_integer(DC_APP_ALIGN_TYPE_BOTTOM);
                dc_node.terrain.alignment.y = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_pivot_point_x && raw_pivot_point_y) {
                ...
                fprintf(stderr, "DCAPP _process_node(): Terrain: invalid PivotParameters; must use both PivotPoint params, or none. Using one is not allowed.\n");
            }
            ...
            if (raw_lat) {
                ...
                strncpy(cleaned_lat, raw_lat, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_lat);
            ...
            if (raw_lon) {
                ...
                strncpy(cleaned_lon, raw_lon, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_lon);
            ...
            if (raw_ele) {
                ...
                strncpy(cleaned_ele, raw_ele, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_ele);
            ...
            if (raw_roll) {
                ...
                strncpy(cleaned_roll, raw_roll, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_roll);
            ...
            if (raw_pitch) {
                ...
                strncpy(cleaned_pitch, raw_pitch, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_pitch);
            ...
            if (raw_yaw) {
                ...
                strncpy(cleaned_yaw, raw_yaw, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_yaw);
        ...
        case DC_APP_ELEM_TYPE_TEXT: {
            ...
            if (raw_text) {
                ...
                strncpy(cleaned_text, raw_text, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_text);
            ...
            if (raw_x_align) {
                ...
                DcValue value            = dc_value_create_value_integer(DC_APP_ALIGN_TYPE_LEFT);
                dc_node.text.alignment.x = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_y_align) {
                ...
                DcValue value            = dc_value_create_value_integer(DC_APP_ALIGN_TYPE_BOTTOM);
                dc_node.text.alignment.y = dc_app_lookup_register_value(data.lookup, &value);
            }
            ...
            if (raw_pivot_point_x && raw_pivot_point_y) {
                ...
                fprintf(stderr, "DCAPP _process_node(): Text: invalid PivotParameters; must use both PivotPoint params, or none. Using one is not allowed.\n");
            }
            ...
            if (raw_size) {
                ...
                strncpy(cleaned_size, raw_size, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_size);
        ...
        case DC_APP_ELEM_TYPE_TRICK_IO: {
            ...
            if (raw_host) {
                strncpy(host, raw_host, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_host);
            } else {
            ...
            if (raw_port) {
                ...
                strncpy(cleaned_port, raw_port, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_port);
            ...
            if (raw_data_rate) {
                ...
                strncpy(cleaned_data_rate, raw_data_rate, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_data_rate);
        ...
        case DC_APP_ELEM_TYPE_TRICK_VARIABLE: {
            ...
            if (raw_trick_path) {
                strncpy(trick_path, raw_trick_path, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_trick_path);
            } else {
            ...
            if (raw_dcapp_var) {
                strncpy(dcapp_var, raw_dcapp_var, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_dcapp_var);
            } else {
            ...
            char *units = NULL;
            if (raw_units) {
                strncpy(cleaned_units, raw_units, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_units);
                units = cleaned_units;
            }
        ...
        case DC_APP_ELEM_TYPE_VARIABLE: {
            ...
            if (raw_name) {
                strncpy(name, raw_name, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_name);
            } else {
            ...
            if (raw_initial_value) {
                ...
                strncpy(cleaned_initial_value, raw_initial_value, DC_VALUE_STRING_BUFFER_SIZE - 1);
        ...
        case DC_APP_ELEM_TYPE_WINDOW: {
            ...
            if (raw_title) {
                ...
                strncpy(cleaned_title, raw_title, DC_VALUE_STRING_BUFFER_SIZE - 1);
                free(raw_title);
            ...
            if (raw_x_virtual_dimension) {
                ...
                dc_node.window.virtual_dimensions.x = dc_node.window.dimensions.x;
            }
            ...
            if (raw_y_virtual_dimension) {
                ...
                dc_node.window.virtual_dimensions.y = dc_node.window.dimensions.y;
            }
...
static void _draw_node(_PlAppData *pl_app_data, _NodeIndex node_index, plMat4 *parent_transform) {
    ...
    switch (node->type) {
        ...
        case NODE_TYPE_TERRAIN: {
            ...
            DcAppAlignType alignment[2]   = {(DcAppAlignType)dc_app_lookup_get_value(data.lookup, node->terrain.alignment.x)->value_integer, (DcAppAlignType)dc_app_lookup_get_value(data.lookup, node->terrain.alignment.y)->value_integer};
            ...
            if (use_local_pivot) {
                ...
                float pivot_point_x = dc_app_lookup_get_value(data.lookup, node->terrain.pivot_point.x)->value_double;
                trans_pivot_vec[0]  = -1 * pivot_point_x;
                float pivot_point_y = dc_app_lookup_get_value(data.lookup, node->terrain.pivot_point.y)->value_double;
        ...
        case NODE_TYPE_TEXT: {
            ...
            DcAppAlignType alignment[2]   = {(DcAppAlignType)dc_app_lookup_get_value(data.lookup, node->text.alignment.x)->value_integer, (DcAppAlignType)dc_app_lookup_get_value(data.lookup, node->text.alignment.y)->value_integer};
            ...
            if (use_local_pivot) {
                ...
                float pivot_point_x = (float)dc_app_lookup_get_value(data.lookup, node->text.pivot_point.x)->value_double;
                trans_pivot_vec[0]  = -1 * pivot_point_x;
                float pivot_point_y = (float)dc_app_lookup_get_value(data.lookup, node->text.pivot_point.y)->value_double;
                trans_pivot_vec[1]  = -1 * pivot_point_y;
            }
            plMat4 trans_to_pivot_xform = pl_mat4_translate_xyz(
                trans_pivot_vec[0],
