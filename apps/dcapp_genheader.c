...
int main(int argc, char **argv) {
    ...
    fprintf(file, "%s\n", "    void (*planet_polygon_geodetic)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3 *points, uint32_t point_count, float line_width, DcVec4 color);");
    fprintf(file, "%s\n", "    void (*planet_polygon_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3 *points, uint32_t point_count, float line_width, DcVec4 color);");
    fprintf(file, "%s\n", "    void (*planet_convex_polygon_filled_geodetic)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3 *points, uint32_t point_count, DcVec4 color);");
    fprintf(file, "%s\n", "    void (*planet_convex_polygon_filled_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3 *points, uint32_t point_count, DcVec4 color);");
    ...
    fprintf(file, "%s\n", "    void (*planet_ellipse_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, DcVec3 center, DcVec2 radius, float rotation_degrees, uint32_t segments, float line_width, DcVec4 color);");
    ...
    fprintf(file, "%s\n", "    void (*planet_ellipse_filled_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, DcVec3 center, DcVec2 radius, float rotation_degrees, uint32_t segments, DcVec4 color);");
