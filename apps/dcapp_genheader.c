...
int main(int argc, char **argv) {
    ...
    fprintf(file, "%s\n", "    void (*planet_ellipse_geodetic)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, double lat, double lon, double height, DcVec2 radius, float rotation_degrees, uint32_t segments, float line_width, DcVec4 line_color, DcVec4 fill_color);");
    fprintf(file, "%s\n", "    void (*planet_ellipse_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, DcVec3 center, DcVec2 radius, float rotation_degrees, uint32_t segments, float line_width, DcVec4 line_color, DcVec4 fill_color);");
