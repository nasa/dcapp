...
int main(int argc, char **argv) {
    ...
    fprintf(file, "%s\n", "    void (*planet_polygon_local)(DcDrawContext *draw_ctx, const DcVec2 *points, uint32_t point_count, float line_width, DcVec4 color);");
    ...
    fprintf(file, "%s\n", "    void (*planet_line_geodetic)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3d *points, uint32_t point_count, float line_width, DcVec4 color);");
    fprintf(file, "%s\n", "    void (*planet_line_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3d *points, uint32_t point_count, float line_width, DcVec4 color);");
    fprintf(file, "%s\n", "    void (*planet_polygon_geodetic)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3d *points, uint32_t point_count, float line_width, DcVec4 color);");
    fprintf(file, "%s\n", "    void (*planet_polygon_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, const DcVec3d *points, uint32_t point_count, float line_width, DcVec4 color);");
    ...
    fprintf(file, "%s\n", "    void (*planet_image_cartesian)(DcDrawContext *draw_ctx, DcDrawPlanetViewHandle view, DcVec3d position, DcTextureId texture_id, DcVec2 size, DcVec4 tint);");
