...
static const char *_valid_attrs_pixelstream[] = {"Type", "URL", "Protocol", "SharedMemoryKey", "File", "Timeout", "TestPattern", NULL};
...
static const char *_valid_attrs_planet_image[] = {"File", "Width", "Height", "DimensionX", "DimensionY", "Yaw", "TintColor", "Color", NULL};
