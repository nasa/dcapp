                    ...
                    if (!(current->object.pixelstream.shm->writing))
                    {
                        ...
                        if (current->object.pixelstream.buffercount != current->object.pixelstream.shm->buffercount)
                        {
                            ...
                            if (newh > current->object.pixelstream.shm->height)
                            {
                                ...
                                bzero((void *)((size_t)(current->object.pixelstream.pixels) + nbytes - padbytes), padbytes);
                                fread((void *)((size_t)(current->object.pixelstream.pixels) + padbytes), 1, origbytes, current->object.pixelstream.fp);
                            }
                            else
                            {
                        ...
                        if (updated)
                        {
                            if (newh < current->object.pixelstream.shm->height)
                            {
                                ...
                                set_texture(current->object.pixelstream.textureID, current->object.pixelstream.shm->width, newh, (void *)((size_t)(current->object.pixelstream.pixels) + offsetbytes));
                            }
                            else
